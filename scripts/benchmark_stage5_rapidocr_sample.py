...
def benchmark() -> dict:
    ...
    for item in sample["documents"]:
        ...
        for sample_page in item["sample_pages"]:
            page_number = int(sample_page["pdf_page"])
            try:
    ...
    return {
        ...
        "boundaries": [
            ...
            "No alternate OCR engine is installed in the current environment; engine selection remains open until the benchmark decision."
        ],
    }

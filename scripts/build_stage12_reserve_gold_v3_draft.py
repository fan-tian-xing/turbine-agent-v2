...
def _specs() -> dict[str, list[dict]]:
    ...
    return {
        "D300N": [
            ...
            {"t": "地脚螺栓孔的位置误差和形状误差会影响机组安装。", "ty": "fact", "p": "causes", "m": "descriptive", "d": "cause_to_effect", "e": [("地脚螺栓孔位置误差", "subject", "parameter"), ("地脚螺栓孔形状误差", "subject", "parameter"), ("机组安装", "object", "process")]},
            {"t": "施工前必须认真阅读地脚螺栓和预埋件图。", "ty": "requirement", "p": "requires", "m": "must", "e": [("施工人员", "subject", "organization"), ("地脚螺栓和预埋件图", "object", "document")], "a": {"activity": "施工前", "status": "known"}},
            {"t": "基础浇灌前及浇灌完工后，均应检查地脚螺栓孔、其他预留孔和预埋件的位置是否符合基础施工图及安装要求。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("施工人员", "subject", "organization"), ("地脚螺栓孔", "object", "component"), ("其他预留孔", "object", "component"), ("预埋件", "object", "component"), ("基础施工图", "related", "document")], "a": {"activity": "基础浇灌前及浇灌完工后", "status": "known"}},
            {"t": "应依据基础基准线和地脚螺孔实际偏差确定汽轮发电机组及凝汽器中心线，并清楚标记基准线和中心线。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("施工人员", "subject", "organization"), ("基础基准线", "object", "parameter"), ("地脚螺孔实际偏差", "object", "parameter"), ("汽轮发电机组中心线", "object", "parameter"), ("凝汽器中心线", "object", "parameter")], "l": "表2-2-1第1项"},
            ...
            {"t": "应复核地脚螺栓孔中心线位置尺寸、数量及孔内壁垂直度符合要求。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("施工人员", "subject", "organization"), ("地脚螺栓孔中心线位置尺寸", "object", "parameter"), ("地脚螺栓孔数量", "object", "parameter"), ("孔内壁垂直度", "object", "parameter")], "l": "表2-2-1第3项"},
        ...
        "DL5190.3": [
            {"t": "转子轴颈两端有凸缘时，凸缘与轴承端面间轴向间隙应符合制造厂技术要求。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("转子轴颈凸缘", "subject", "component"), ("轴承端面", "object", "component"), ("轴向间隙", "object", "parameter")], "c": ["转子轴颈两端有凸缘"]},
            ...
            {"t": "齿尖厚度宜为0.10mm～0.20mm。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("齿尖", "subject", "component"), ("齿尖厚度", "object", "parameter")], "q": [{"surface_form": "0.10mm～0.20mm", "min": 0.10, "max": 0.20, "unit": "mm", "operator": "range"}], "l": "4.5.10第2项"},
            ...
            {"t": "锁饼、制动销和温度测量装置应与轴瓦保持适当间隙；锁饼和制动销应能制锁但不卡死；锁饼上平面应低于轴瓦水平结合面。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("锁饼", "subject", "component"), ("制动销", "subject", "component"), ("温度测量装置", "subject", "component"), ("轴瓦", "object", "component"), ("轴瓦水平结合面", "object", "component")], "n": [{"surface_form": "不卡死", "polarity": "negative", "scope_type": "statement"}], "l": "4.5.11"},
            {"t": "轴瓦紧力应符合制造厂技术要求。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("轴瓦紧力", "subject", "parameter"), ("制造厂技术要求", "object", "document")], "l": "4.5.12"},
            {"t": "制造厂无要求时，圆柱形轴瓦紧力宜为0.05mm～0.15mm。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("圆柱形轴瓦紧力", "subject", "parameter")], "q": [{"surface_form": "0.05mm～0.15mm", "min": 0.05, "max": 0.15, "unit": "mm", "operator": "range"}], "c": ["制造厂无要求"], "l": "4.5.12第1项"},
            {"t": "制造厂无要求时，球形轴瓦紧力宜为0.00mm～0.03mm。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("球形轴瓦紧力", "subject", "parameter")], "q": [{"surface_form": "0.00mm～0.03mm", "min": 0.00, "max": 0.03, "unit": "mm", "operator": "range"}], "c": ["制造厂无要求"], "l": "4.5.12第1项"},
            {"t": "轴瓦紧力的测量可采用压熔丝法。", "ty": "procedure", "p": "describes", "m": "descriptive", "e": [("轴瓦紧力测量", "subject", "process"), ("压熔丝法", "object", "process")], "l": "4.5.12第2项"},
            ...
            {"t": "轴承座内部应清洁无杂物，零部件安装齐全，间隙符合制造厂技术要求，螺栓紧固；汽机与热控专业相关人员应共同检查并作隐蔽签证。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("轴承座", "subject", "component"), ("零部件", "object", "component"), ("螺栓", "object", "component"), ("汽机专业人员", "related", "organization"), ("热控专业人员", "related", "organization")], "n": [{"surface_form": "无杂物", "polarity": "negative", "scope_type": "statement"}], "l": "4.5.13第1项"},
            ...
            {"t": "应检查汽缸前后轴封径向间隙以及汽缸前后缸体基准面与转子相应凸肩之间的定位距离，并与制造厂总装记录核对一致。", "ty": "verification", "p": "verifies", "m": "shall", "e": [("汽缸前后轴封径向间隙", "subject", "parameter"), ("汽缸缸体基准面", "object", "component"), ("转子相应凸肩", "object", "component"), ("定位距离", "object", "parameter"), ("制造厂总装记录", "object", "document")], "l": "4.6.1"},
            {"t": "整体组装汽缸模块就位前，轴承座应已定位；需灌浆时强度应达到设计要求；猫爪调整垫片应安装并符合制造厂技术要求；影响就位的下半轴瓦等部件应拆除；就位后无法安装的轴封、抽汽等管道应预先安装完成。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("汽缸模块就位", "subject", "process"), ("轴承座", "object", "component"), ("猫爪调整垫片", "object", "component"), ("下半轴瓦", "object", "component"), ("轴封", "object", "component"), ("抽汽管道", "object", "component")], "a": {"activity": "汽缸模块就位前", "status": "known"}, "l": "4.6.2"},
            ...
            {"t": "径向碰缸试验应按上下左右四个方向测量汽封最小径向间隙；高、中压缸通过移动汽缸，低压缸通过移动内缸。", "ty": "verification", "p": "verifies", "m": "shall", "e": [("径向碰缸试验", "subject", "process"), ("汽封最小径向间隙", "object", "parameter"), ("高压缸", "related", "component"), ("中压缸", "related", "component"), ("低压缸", "related", "component")], "l": "4.6.8第1项"},
        ...
        "DLT863": [],
        "HAF103": [
            {"t": "营运单位应确保可能影响安全的所有活动由具备资格且经授权的人员完成，并对这些活动进行批准、有效控制和监管。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("营运单位", "subject", "organization"), ("具备资格且经授权的人员", "object", "person_role"), ("影响安全的活动", "object", "process")], "l": "2.1.11"},
            ...
            {"t": "配置管理制度应确保对核动力厂安全重要物项的修改进行识别、筛选、设计、审批、实施、评价和记录，并定期升版相关许可证申请文件。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("配置管理制度", "subject", "process"), ("安全重要物项修改", "object", "process"), ("许可证申请文件", "object", "document")], "l": "2.1.13"},
            {"t": "营运单位应建立核动力厂配置状态的风险管理体系。", "ty": "requirement", "p": "requires", "m": "shall", "e": [("营运单位", "subject", "organization"), ("配置状态风险管理体系", "object", "system")], "l": "2.1.14"},
        ...
        "auxiliary_installation_book": [
            ...
            {"t": "给水泵运行中润滑油压低于0.05MPa时，给水泵跳闸。", "ty": "fact", "p": "causes", "m": "descriptive", "d": "cause_to_effect", "e": [("润滑油压低于0.05MPa", "subject", "parameter"), ("给水泵跳闸", "object", "event")], "q": [{"surface_form": "0.05MPa", "value": 0.05, "unit": "MPa", "operator": "lt"}], "c": ["给水泵运行中"], "l": "Lc5A4342，选项B"},
            ...
            {"t": "管螺纹的公称直径指管子内径。", "ty": "fact", "p": "describes", "m": "descriptive", "e": [("管螺纹公称直径", "subject", "parameter"), ("管子内径", "object", "parameter")], "l": "Lc4A1346，选项B"},
...
def _dlt_specs() -> list[dict]:
    ...
    for text, locator, activity in texts:
        out.append({
            ...
            "d": "subject_to_object",
            "e": [("分系统试运", "subject", "process"), ("试运条件", "object", "parameter")],
...
def build() -> tuple[list[dict], dict]:
    ...
    per_reserve = {
        key: {
            ...
            "boundary_issues": "PASS",
            "condition_applicability_issues": "PASS",
            "predicate_issues": "PASS",
            "modality_issues": "PASS_WITH_SCHEMA_MAPPING_NOTE",
            "quantity_issues": "PASS",
            "entity_issues": "PASS_WITH_PENDING_ENTITY_CONFIRMATION",
            "grounding_issues": "PASS",
            "status": "PASS_WITH_PENDING_ENTITY_CONFIRMATION",
        }
    ...
    audit = {
        ...
        "checks": {
            "boundary": "PASS",
            "condition_vs_applicability": "PASS",
            "predicate": "PASS",
            "statement_type": "PASS",
            "normative_modality": "PASS_WITH_SCHEMA_MAPPING_NOTE",
            "quantity": "PASS",
            "negation": "PASS",
            "entity": "PASS_WITH_PENDING_ENTITY_CONFIRMATION",
            "evidence_grounding": "PASS",
            "ocr_incomplete_spans": "PASS_WITH_EXCLUDED_INCOMPLETE_FRAGMENT",
            "candidate_contamination": "PASS",
        },
        "detailed_checks": {
            "independent_requirement_boundary": "PASS",
            "mixed_modality": "PASS",
            "source_locator_not_in_applicability": "PASS",
            "temporal_scope_not_condition": "PASS",
            "genuine_prerequisite_not_applicability": "PASS",
            "limits_scope_not_abused": "PASS",
            "statement_type_matches_normative_nature": "PASS",
            "no_unsupported_normative_strength": "PASS_WITH_SCHEMA_MAPPING_NOTE",
            "quantity_grounding": "PASS",
            "negation_explicit": "PASS",
            "causal_direction": "PASS",
            "entity_completeness": "PASS_WITH_PENDING_ENTITY_CONFIRMATION",
            "numeric_values_not_entities": "PASS",
            "incomplete_cross_page_spans_excluded": "PASS_WITH_EXCLUDED_INCOMPLETE_FRAGMENT",
            "ambiguous_ocr_items_excluded": "PASS_WITH_EXCLUDED_AMBIGUOUS_INTRO_ROW",
            "source_span_recall": "PASS",
            "duplicate_statement_check": "PASS",
            "clause_numbers_not_semantic_fields": "PASS",
            "independent_retrievability": "PASS",
            "no_unnecessary_over_split": "PASS",
        },
        "modality_mapping_note": "The current deterministic contract permits only shall/must/descriptive. Source wording '宜' is preserved verbatim in statement_text and follows the repository's existing deterministic mapping to shall; no recommended enum was introduced.",
        "excluded_items": [
        ...
        "remaining_human_questions": [
            "Confirm stable ontology/entity IDs and whether the seven auxiliary-book answer assertions are acceptable as a distinct textbook-quiz source class.",
            "Confirm the exact answer marking for the auxiliary-book items from the original page visual; no answer is inferred from general knowledge.",
        ],

...
def evaluate() -> dict:
    ...
    candidate_payload = {
        ...
        "provider_metadata": {"provider_id": "historical_observation_fixture_v1", "mode": "fixture", "model_config_identifier": "historical-observation-only", "prompt_version": "stage12-candidate-prompt-v5", "response_schema_version": 2},
